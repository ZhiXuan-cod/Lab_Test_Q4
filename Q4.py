...
if uploaded_file is not None:
    ...
    # Step 3: Preprocess and display sample
    st.subheader("Step 3: Text Preprocessing & Sample")
    ...
    # Step 4: NLTK Sentence Tokenization
    st.subheader("Step 4: NLTK Semantic Sentence Chunking")
...
# GitHub Information
st.markdown("---")
st.markdown("**GitHub Repository**: https://github.com/yourusername/bsd3513-lab-test")
st.markdown("**Files**: `text_chunking.py`, `text_chunking_app.py`")